...
// Board & archive
export const getBoard   = () => fetch(`${BASE}/board`,          { headers: h() }).then(j);
export const getArchive = () => fetch(`${BASE}/archive`,        { headers: h() }).then(j);

// Tags
export const getTags    = () => fetch(`${BASE}/tags`,           { headers: h() }).then(j);
...
// Settings
export const getTheme   = () => fetch(`${BASE}/settings/theme`, { headers: h() }).then(j).then(d => d.value);
